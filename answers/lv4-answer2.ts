 ...
 */
function filterPersonsByRules(persons: Person[], personType: 'user', criteria: Partial<Omit<User, 'type'>>): User[]
function filterPersonsByRules(persons: Person[], personType: 'admin', criteria: Partial<Omit<Admin, 'type'>>): Admin[]
function filterPersonsByRules(persons: Person[], personType: string, criteria: Partial<Omit<Person, 'type'>>): Person[] {
  return persons
